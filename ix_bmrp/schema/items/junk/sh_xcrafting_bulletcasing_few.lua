ITEM.name = "Handful of bullet casings"
ITEM.description = "A small handful of bullet casings, ready to be loaded.\n\nCan be combined with bullet rounds or more casings."
ITEM.category = "Junk"
