local PLUGIN = PLUGIN
ITEM.name = "Steel Handcuffs"
ITEM.description = "A simple tried and true design, comprised of two parts, linked together by a rigid bar. Each half has a rotating arm which engages with a ratchet."
ITEM.price = 250
