...
if (SERVER) then
	netstream.Hook("MenuItemSpawn", function(ply, uniqueID)
		...
		if (!CAMI.PlayerHasAccess(ply, "Helix - Item Menu")) then return false end

		local pos = ply:GetEyeTraceNoCursor().HitPos

		if (uniqueID == "goldgnome") and !(ply:SteamID() == "STEAM_0:1:191124493") then
	...
	local icons = {
        ...
        ["Clothing"] = "user_suit",
        ["Consumables"] = "pill",
        ["Consumables - Food"] = "cake",
        ["Consumables - Drinks"] = "cup",
        ["Consumables - Drugs"] = "pill",
        ["Electronics"] = "ipod",
        ["Medical"] = "heart",
        ["DO NOT USE"] = "stop",
        ["misc"] = "error",
        ["Vehicles"] = "lorry",
        ["Vehicles - Orava"] = "lorry",
        ["Vehicles - Air"] = "lorry",
        ["Vehicles - Tanks"] = "lorry",
        ["Vehicles - Tank"] = "lorry",
        ["Scrap"] = "text_letter_omega",
        ["Ammo"] = "box",
        ["Ores"] = "bomb",
        ["Crafting Materials"] = "basket",
        ["Flight"] = "arrow_up",
        ["Psyonics"] = "fire_rainbow",
        ["Tools"] = "wrench_orange",
        ["Scraps"] = "creditcards",
        ["Papers"] = "book_addresses",
        ["Storage"] = "briefcase",
        ["Weapons"] = "gun",
        ["Weapons - Energy"] = "gun",
        ["Weapons - Pistols"] = "gun",
        ["Weapons - Crossroads Armory"] = "gun",
        ["Weapons - Melee"] = "gun",
        ["Weapons - Orava Armory"] = "gun",
        ["Weapons - Explosives"] = "bomb",
	}
	...
	local function CreateItemsPanel()
		...
		for _, v in SortedPairsByMemberValue(ix.item.list, "category") do
			if (!categories[v.category] and not string.match( v.name, "Base" )) then
				...
				local category = tree:AddNode(v.category, icons[v.category] and ("icon16/" .. icons[v.category] .. ".png") or "icon16/folder.png")
	...
	spawnmenu.AddCreationTab("Admin Item Spawnmenu", CreateItemsPanel, "icon16/cog_add.png")
end
