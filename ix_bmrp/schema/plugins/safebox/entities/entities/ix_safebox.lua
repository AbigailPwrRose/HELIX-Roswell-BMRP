ENT.Type = "anim"
ENT.PrintName = "Sidereal Connected Storage Unit"
ENT.Category = "Helix"
ENT.Spawnable = true
ENT.AdminOnly = true
ENT.bNoPersist = true
...
if (SERVER) then
	function ENT:Initialize()
		self:SetModel("models/props/halflifeoneprops5/locker.mdl")
	...
	function ENT:OnPopulateEntityInfo(tooltip)
		...
		description:SetText("Developed by Sidereal Plexus, these lockers utalise patented technology to create a personal, linked storage space for its users.")
