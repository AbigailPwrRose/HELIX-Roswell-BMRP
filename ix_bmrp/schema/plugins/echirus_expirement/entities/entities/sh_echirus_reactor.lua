...
ENT.PrintName = "Echirus Reactor Intake"
ENT.Description = "A vastly complex reactor systems intake aparatus. Liquid Energy and Echirus can be inserted, and payments dispensed based on volume."
ENT.Author = "Winter"
ENT.Spawnable = true
ENT.AdminSpawnable = true
ENT.Model = "models/props_industrial/powerbox_large_01.mdl"
