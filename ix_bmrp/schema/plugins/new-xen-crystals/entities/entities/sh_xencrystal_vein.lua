ENT.Type = "anim"
ENT.PrintName = "Xen Crystal Vein"
ENT.Category = "Black Mesa: Xen Crystals"
ENT.Model = "models/props_xen/crystals/xen_crystals_orange_3_micro.mdl"
ENT.Spawnable = true
ENT.AdminOnly = true
ENT.bNoPersist = true
...
if (SERVER) then
    ...
    function ENT:GenerateShard()
        ...
        local Shard = ents.Create("xencrystal_overworld")
