...
function ITEM:GetDescription()
  ...
  local addon = "Interior volume of "..self.invWidth.." by "..self.invHeight
  return desc.."\n\n"..addon
end
...
function ITEM:CanTransfer(oldInventory, newInventory)
	...
	if (newInventory) then
		if (newInventory.vars and newInventory.vars.isBag) and !(newInventory.vars.isBag=="safebox") then
			return false
		end
	...
	return !newInventory or newInventory:GetID() != oldInventory:GetID() or IsBag
end
